#!/bin/bash
# bash scNMT_DNA_QC_trimming_hisat3n_alignment_PE_get_foldername_as_parameter.sh folder_name
set -e
# load modules
...
top_level_folder="/data/yangg3/Novogene20220210"
## Initialize the sample folder. Must use full path!!
## This folder should contain the paired-end fatq.gz files for one sample.
sample_folder=$1 # This is the folder for sample E1G_1 which contains paired-end fastq files
...
hisat-3n -p 6 -x /data/yangg3/mouse_genome_index/GRCm38.plus.lambda.hisat3n_index/GRCm38.plus.lambda \
...
# hisat-3n-table
hisat-3n-table --threads 6 --alignments $sample_folder\_PE_hisat3n_unique_alignment_results_sorted.deduplicated.sam --ref /data/yangg3/mouse_genome_index/GRCm38.plus.lambda.hisat3n_index/Mus_musculus.GRCm38.dna.GRCm38.dna.primary_assembly_plus_lambda_DNA.fa --output-name $sample_folder\_CtoT.tsv --base-change C,T
